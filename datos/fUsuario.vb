...
Public Class fUsuario
    ...
    Public Function Mostrar_Usuario() As DataTable 'tipodatatable, crea en memoria una tabla cargada con info que genera desde el comando que ejecutemos'

        'Función que cargará en memoria la tabla TipoSorteo

        Try
            funcConectarDB()  'abrir conexión con base de datos'
            cmd = New SqlCommand("procMostrar_Usuario") 'procedimiento almacenado que consulta y muestra los tipos de sorteos y los ordena por nombre, se llama procMostrar_TipoSorteo' 
    ...
    Public Function Insertar_Usuario(ByVal dts As logUsuario) As Boolean
    ...
    Public Function Eliminar_Usuario(ByVal dts As logUsuario) As Boolean
